...
var (
	...
	cacheLooklookHomestayBusinessIdPrefix     = "cache:looklook:homestayBusiness:id:"
	cacheLooklookHomestayBusinessUserIdPrefix = "cache:looklook:homestayBusiness:userId:"
)
...
func (m *defaultHomestayBusinessModel) Insert(ctx context.Context, session sqlx.Session, data *HomestayBusiness) (sql.Result, error) {
	...
	looklookHomestayBusinessIdKey := fmt.Sprintf("%s%v", cacheLooklookHomestayBusinessIdPrefix, data.Id)
	looklookHomestayBusinessUserIdKey := fmt.Sprintf("%s%v", cacheLooklookHomestayBusinessUserIdPrefix, data.UserId)
	...
	}, looklookHomestayBusinessIdKey, looklookHomestayBusinessUserIdKey)
}

func (m *defaultHomestayBusinessModel) FindOne(ctx context.Context, id int64) (*HomestayBusiness, error) {
	looklookHomestayBusinessIdKey := fmt.Sprintf("%s%v", cacheLooklookHomestayBusinessIdPrefix, id)
	var resp HomestayBusiness
	err := m.QueryRowCtx(ctx, &resp, looklookHomestayBusinessIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultHomestayBusinessModel) FindOneByUserId(ctx context.Context, userId int64) (*HomestayBusiness, error) {
	looklookHomestayBusinessUserIdKey := fmt.Sprintf("%s%v", cacheLooklookHomestayBusinessUserIdPrefix, userId)
	var resp HomestayBusiness
	err := m.QueryRowIndexCtx(ctx, &resp, looklookHomestayBusinessUserIdKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) (i interface{}, e error) {
...
func (m *defaultHomestayBusinessModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheLooklookHomestayBusinessIdPrefix, primary)
}
