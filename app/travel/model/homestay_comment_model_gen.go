...
var (
	...
	cacheLooklookHomestayCommentIdPrefix = "cache:looklook:homestayComment:id:"
)
...
func (m *defaultHomestayCommentModel) Insert(ctx context.Context, session sqlx.Session, data *HomestayComment) (sql.Result, error) {
	...
	looklookHomestayCommentIdKey := fmt.Sprintf("%s%v", cacheLooklookHomestayCommentIdPrefix, data.Id)
	...
	}, looklookHomestayCommentIdKey)
}

func (m *defaultHomestayCommentModel) FindOne(ctx context.Context, id int64) (*HomestayComment, error) {
	looklookHomestayCommentIdKey := fmt.Sprintf("%s%v", cacheLooklookHomestayCommentIdPrefix, id)
	var resp HomestayComment
	err := m.QueryRowCtx(ctx, &resp, looklookHomestayCommentIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultHomestayCommentModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheLooklookHomestayCommentIdPrefix, primary)
}
