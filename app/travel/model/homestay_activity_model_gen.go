...
var (
	...
	cacheLooklookHomestayActivityIdPrefix = "cache:looklook:homestayActivity:id:"
)
...
func (m *defaultHomestayActivityModel) Insert(ctx context.Context, session sqlx.Session, data *HomestayActivity) (sql.Result, error) {
	...
	looklookHomestayActivityIdKey := fmt.Sprintf("%s%v", cacheLooklookHomestayActivityIdPrefix, data.Id)
	...
	}, looklookHomestayActivityIdKey)
}

func (m *defaultHomestayActivityModel) FindOne(ctx context.Context, id int64) (*HomestayActivity, error) {
	looklookHomestayActivityIdKey := fmt.Sprintf("%s%v", cacheLooklookHomestayActivityIdPrefix, id)
	var resp HomestayActivity
	err := m.QueryRowCtx(ctx, &resp, looklookHomestayActivityIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultHomestayActivityModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheLooklookHomestayActivityIdPrefix, primary)
}
