...
var (
	...
	cacheLooklookHomestayIdPrefix = "cache:looklook:homestay:id:"
)
...
func (m *defaultHomestayModel) Insert(ctx context.Context, session sqlx.Session, data *Homestay) (sql.Result, error) {
	...
	looklookHomestayIdKey := fmt.Sprintf("%s%v", cacheLooklookHomestayIdPrefix, data.Id)
	...
	}, looklookHomestayIdKey)
}

func (m *defaultHomestayModel) FindOne(ctx context.Context, id int64) (*Homestay, error) {
	looklookHomestayIdKey := fmt.Sprintf("%s%v", cacheLooklookHomestayIdPrefix, id)
	var resp Homestay
	err := m.QueryRowCtx(ctx, &resp, looklookHomestayIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultHomestayModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheLooklookHomestayIdPrefix, primary)
}
