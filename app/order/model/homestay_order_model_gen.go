...
var (
	...
	cacheLooklookHomestayOrderIdPrefix = "cache:looklook:homestayOrder:id:"
	cacheLooklookHomestayOrderSnPrefix = "cache:looklook:homestayOrder:sn:"
)
...
func (m *defaultHomestayOrderModel) Insert(ctx context.Context, session sqlx.Session, data *HomestayOrder) (sql.Result, error) {
	...
	looklookHomestayOrderIdKey := fmt.Sprintf("%s%v", cacheLooklookHomestayOrderIdPrefix, data.Id)
	looklookHomestayOrderSnKey := fmt.Sprintf("%s%v", cacheLooklookHomestayOrderSnPrefix, data.Sn)
	...
	}, looklookHomestayOrderIdKey, looklookHomestayOrderSnKey)
}

func (m *defaultHomestayOrderModel) FindOne(ctx context.Context, id int64) (*HomestayOrder, error) {
	looklookHomestayOrderIdKey := fmt.Sprintf("%s%v", cacheLooklookHomestayOrderIdPrefix, id)
	var resp HomestayOrder
	err := m.QueryRowCtx(ctx, &resp, looklookHomestayOrderIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultHomestayOrderModel) FindOneBySn(ctx context.Context, sn string) (*HomestayOrder, error) {
	looklookHomestayOrderSnKey := fmt.Sprintf("%s%v", cacheLooklookHomestayOrderSnPrefix, sn)
	var resp HomestayOrder
	err := m.QueryRowIndexCtx(ctx, &resp, looklookHomestayOrderSnKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) (i interface{}, e error) {
...
func (m *defaultHomestayOrderModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheLooklookHomestayOrderIdPrefix, primary)
}
