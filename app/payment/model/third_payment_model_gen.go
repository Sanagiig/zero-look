...
var (
	...
	cacheLooklookThirdPaymentIdPrefix = "cache:looklook:thirdPayment:id:"
	cacheLooklookThirdPaymentSnPrefix = "cache:looklook:thirdPayment:sn:"
)
...
func (m *defaultThirdPaymentModel) Insert(ctx context.Context, session sqlx.Session, data *ThirdPayment) (sql.Result, error) {
	...
	looklookThirdPaymentIdKey := fmt.Sprintf("%s%v", cacheLooklookThirdPaymentIdPrefix, data.Id)
	looklookThirdPaymentSnKey := fmt.Sprintf("%s%v", cacheLooklookThirdPaymentSnPrefix, data.Sn)
	...
	}, looklookThirdPaymentIdKey, looklookThirdPaymentSnKey)
}

func (m *defaultThirdPaymentModel) FindOne(ctx context.Context, id int64) (*ThirdPayment, error) {
	looklookThirdPaymentIdKey := fmt.Sprintf("%s%v", cacheLooklookThirdPaymentIdPrefix, id)
	var resp ThirdPayment
	err := m.QueryRowCtx(ctx, &resp, looklookThirdPaymentIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultThirdPaymentModel) FindOneBySn(ctx context.Context, sn string) (*ThirdPayment, error) {
	looklookThirdPaymentSnKey := fmt.Sprintf("%s%v", cacheLooklookThirdPaymentSnPrefix, sn)
	var resp ThirdPayment
	err := m.QueryRowIndexCtx(ctx, &resp, looklookThirdPaymentSnKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) (i interface{}, e error) {
...
func (m *defaultThirdPaymentModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheLooklookThirdPaymentIdPrefix, primary)
}
