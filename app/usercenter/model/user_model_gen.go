...
var (
	...
	cacheLooklookUserIdPrefix     = "cache:looklook:user:id:"
	cacheLooklookUserMobilePrefix = "cache:looklook:user:mobile:"
)
...
func (m *defaultUserModel) FindOne(ctx context.Context, id int64) (*User, error) {
	looklookUserIdKey := fmt.Sprintf("%s%v", cacheLooklookUserIdPrefix, id)
	var resp User
	err := m.QueryRowCtx(ctx, &resp, looklookUserIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultUserModel) FindOneByMobile(ctx context.Context, mobile string) (*User, error) {
	looklookUserMobileKey := fmt.Sprintf("%s%v", cacheLooklookUserMobilePrefix, mobile)
	var resp User
	err := m.QueryRowIndexCtx(ctx, &resp, looklookUserMobileKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) (i interface{}, e error) {
...
func (m *defaultUserModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheLooklookUserIdPrefix, primary)
}
